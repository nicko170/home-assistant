...
async def device_scan(
    ...
    # PATCHED (2026-08-29): same reason as _scan() in __init__.py - passing
    # HA's shared AsyncZeroconf makes pyatv find nothing. This is why adding a
    # device by name or by IP returned "no_devices_found" while a standalone
    # scan found it instantly.
